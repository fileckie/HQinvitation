      ...
      <header className="bg-white border-b border-[#e8e4de] sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="font-serif-title text-lg font-bold text-[#0a0a0a]">编辑宴请</h1>
          </div>
      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        <form onSubmit={handleSubmit}>
          ...
          {activeTab === 'info' && (
            <div className="space-y-6 animate-fade-in">
              <div className="bg-white rounded-2xl p-6 border border-[#e8e4de]">
                <h2 className="font-serif-title text-lg font-bold text-[#0a0a0a] mb-6">基本信息</h2>
            ...
            <div className="space-y-6 animate-fade-in">
              <div className="bg-white rounded-2xl p-6 border border-[#e8e4de]">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="font-serif-title text-lg font-bold text-[#0a0a0a]">今日菜单</h2>
                  <button
                    type="button"
                    onClick={addDish}
          ...
          {activeTab === 'restaurant' && (
            <div className="space-y-6 animate-fade-in">
              <div className="bg-white rounded-2xl p-6 border border-[#e8e4de]">
                <h2 className="font-serif-title text-lg font-bold text-[#0a0a0a] mb-6">餐厅信息</h2>
                <div className="grid md:grid-cols-2 gap-5">
                  <div className="md:col-span-2">
