        ...
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <h1 className="font-serif-title text-lg font-bold text-[#0a0a0a]">宴请管理</h1>
            </div>
          </div>
          <Link 
            href="/admin"
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-white rounded-xl p-5 border border-[#e8e4de]">
            ...
            <div className="font-serif-title text-2xl font-bold text-[#0a0a0a]">{stats.total}</div>
          </div>
          <div className="bg-white rounded-xl p-5 border border-[#e8e4de]">
            <div className="flex items-center gap-2 mb-2">
            ...
            <div className="font-serif-title text-2xl font-bold text-[#0a0a0a]">{stats.thisMonth}</div>
          </div>
          <div className="bg-white rounded-xl p-5 border border-[#e8e4de]">
            <div className="flex items-center gap-2 mb-2">
            ...
            <div className="font-serif-title text-2xl font-bold text-[#0a0a0a]">{stats.pending}</div>
          </div>
          <div className="bg-white rounded-xl p-5 border border-[#e8e4de]">
            <div className="flex items-center gap-2 mb-2">
            ...
            <div className="font-serif-title text-2xl font-bold text-[#0a0a0a]">{stats.confirmed}</div>
          </div>
        </div>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h3 className="font-serif-title text-lg font-bold text-[#0a0a0a]">{banquet.title}</h3>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-white rounded-2xl p-6 w-full max-w-sm animate-fade-in-scale">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-serif-title text-lg font-bold text-[#0a0a0a]">{selectedBanquet.title}</h3>
      ...
      {showDelete && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-white rounded-2xl p-6 w-full max-w-sm animate-fade-in-scale">
            ...
            <h3 className="font-serif-title text-lg font-bold text-[#0a0a0a] text-center mb-2">
              确认删除？
            </h3>
